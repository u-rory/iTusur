...
public class test2 extends Fragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        pagerAdapter = new test2.MyFragmentPagerAdapter(getChildFragmentManager());
    ...
    private class MyFragmentPagerAdapter extends FragmentPagerAdapter {
        ...
        @Override
        public Fragment getItem(int position) {return fragmentforviewpager2.newInstance(position);}
        @Override
